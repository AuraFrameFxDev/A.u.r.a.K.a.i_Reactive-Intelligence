...
class AIContentApi(
    ...
    fun aiGenerateImageDescriptionPostWithHttpInfo(
        generateImageDescriptionRequest: GenerateImageDescriptionRequest,
    ): ApiResponse<GenerateImageDescriptionResponse?> {
     ...
     */
    fun aiGenerateImageDescriptionPostRequestConfig(
        generateImageDescriptionRequest: GenerateImageDescriptionRequest,
    ): RequestConfig<GenerateImageDescriptionRequest> {
