...
data class VertexAIConfig(
     ...
     */
    fun getFullEndpoint(): String = "https://$endpoint/$apiVersion/projects/$projectId/locations/$location"
     ...
     */
    fun getModelEndpoint(): String = "${getFullEndpoint()}/publishers/google/models/$modelName:generateContent"
