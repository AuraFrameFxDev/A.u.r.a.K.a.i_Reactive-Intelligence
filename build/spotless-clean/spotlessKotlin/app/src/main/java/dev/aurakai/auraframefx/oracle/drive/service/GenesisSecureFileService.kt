 ...
 */
@Singleton
class GenesisSecureFileService
    @Inject
    constructor(
         ...
         */
        private fun getKeyAlias(fileName: String): String = "oracle_drive_${fileName.hashCode()}"
         ...
         */
        private fun getMetadataKey(fileName: String): String = "file_meta_${fileName.hashCode()}"
