...
class ConferenceRoom(
     ...
     */
    fun aggregateConsensus(
        responses: List<Map<String, dev.aurakai.auraframefx.model.AgentResponse>>,
    ): Map<String, dev.aurakai.auraframefx.model.AgentResponse> = orchestrator.aggregateAgentResponses(responses)
     ...
     */
    fun getRoomSnapshot(): Map<String, Any> =
        mapOf(
            "name" to name,
    ...
    // --- Utility & Diagnostics ---
    fun getRoomMetadata(): Map<String, Any> =
        mapOf(
            "name" to name,
