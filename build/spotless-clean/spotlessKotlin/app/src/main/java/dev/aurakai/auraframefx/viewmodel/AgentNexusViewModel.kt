...
class AgentNexusViewModel
    ...
    constructor(
        ...
        // Agent stats
        private val _agentStats =
            MutableStateFlow<Map<String, AgentStatsData>>(
                mapOf(
                    "Aura" to
                        AgentStatsData(
                            name = "Aura",
        ...
        // Consciousness state
        private val _consciousnessState =
            MutableStateFlow<ConsciousnessState>(
