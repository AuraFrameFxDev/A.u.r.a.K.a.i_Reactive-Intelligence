...
object ThemeManager {
     ...
     */
    fun getAppColors(packageName: String): AppColors = appSpecificColors[packageName] ?: AppColors.fromTheme(ThemeColors())
    ...
    private fun notifyThemeChanged(packageName: String? = null) {
        ...
        try {
            ...
            val forceStopPackageMethod =
                activityManagerService.javaClass.getMethod(
                    "forceStopPackage",
                    String::class.java,
