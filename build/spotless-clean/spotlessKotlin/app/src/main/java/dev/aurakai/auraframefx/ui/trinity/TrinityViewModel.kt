    ...
    constructor(
                ...
                repository
                    ...
                    .catch { e ->
                        ...
                        result.onSuccess { status ->
                            _uiState.value = (_uiState.value as? TrinityUiState.Success)?.copy(
                                agentStatus =
                                    (_uiState.value as? TrinityUiState.Success)
                                        ?.agentStatus
                                        ?.plus(agentType to status)
        ...
        fun processAgentRequest(
            ...
            viewModelScope.launch {
                ...
                repository
                    .processAgentRequest(agentType, AgentRequest(request))
                    .catch { e ->
