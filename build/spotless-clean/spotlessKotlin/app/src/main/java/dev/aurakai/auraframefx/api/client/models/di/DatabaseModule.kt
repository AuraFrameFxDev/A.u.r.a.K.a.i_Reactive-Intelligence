...
object DatabaseModule {
     ...
     */
    @Provides
    fun provideAgentMemoryDao(database: AppDatabase): AgentMemoryDao = database.agentMemoryDao()

    @Provides
    fun provideTaskHistoryDao(database: AppDatabase): TaskHistoryDao = database.taskHistoryDao()
}
