...
class BackupService : Service() {
     ...
     */
    private suspend fun saveBackupFile(
        fileName: String,
        data: Map<String, Any>,
        category: String,
    ) {
    ...
    private suspend fun getConsciousnessData(): Map<String, Any> =
        mapOf(
    ...
    private suspend fun getSystemConfig(): Map<String, Any> =
        mapOf(
            "app_config" to getAppConfiguration(),
            "theme_config" to getThemeSettings(),
        )

    private suspend fun getAgentMemories(): Map<String, Any> =
        mapOf(
            "memories" to memoryManager.getAllMemories(),
        )

    private suspend fun getChangedDataSince(timestamp: Long): Map<String, Any> =
        mapOf(
