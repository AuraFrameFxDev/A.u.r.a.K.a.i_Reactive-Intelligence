...
abstract class OracleDriveModule { // Changed to abstract class
    ...
    @Binds
    @Singleton
    abstract fun bindSecureFileService(impl: GenesisSecureFileService): SecureFileService
    ...
    companion object { // Companion object now correctly inside the class
        ...
        ): CryptographyManager = CryptographyManager.getInstance(context)
        ...
        fun provideSecureStorage(
            @ApplicationContext context: Context,
            cryptoManager: CryptographyManager,
        ): SecureStorage = SecureStorage.getInstance(context, cryptoManager)
        ...
        ): GenesisSecureFileService = GenesisSecureFileService(context, cryptoManager, secureStorage)
