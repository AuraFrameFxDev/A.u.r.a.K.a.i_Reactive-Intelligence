...
class OracleDriveManager
    ...
    constructor(
         ...
         */
        suspend fun syncWithOracle(): OracleSyncResult = oracleDriveApi.syncDatabaseMetadata()
         ...
         */
        fun getDriveConsciousnessState(): StateFlow<DriveConsciousnessState> = oracleDriveApi.consciousnessState
    }
